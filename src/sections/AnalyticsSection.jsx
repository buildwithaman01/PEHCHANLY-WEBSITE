  ...
  <section className="py-24 bg-[#050816]">
    <div className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <AnimatedSection delay={0.1} className="bg-[#0a0e26] p-8 rounded-2xl border border-white/10 hover:border-[#00f0ff]/30 hover:-translate-y-2 transition-all duration-300">
        ...
        <AnimatedSection delay={0.2} className="bg-[#0a0e26] p-8 rounded-2xl border border-white/10 hover:border-[#ffd700]/30 hover:-translate-y-2 transition-all duration-300">
      ...
      <AnimatedSection delay={0.3} className="bg-gradient-to-r from-[#00f0ff]/10 to-transparent border-l-4 border-[#00f0ff] rounded-r-2xl p-8">
