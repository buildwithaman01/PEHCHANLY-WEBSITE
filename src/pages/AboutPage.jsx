...
const AboutPage = ({ setPage }) => (
  <div className="pt-32 pb-24 px-6 container mx-auto animate-fadeIn">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
       {TEAM.map((member, i) => (
          <div key={i} className="bg-[#0a0e26] p-6 rounded-2xl text-center border border-white/5 hover:border-[#00f0ff]/30 transition-all group">
             <div className="relative w-24 h-24 mx-auto mb-4">
                <div className="absolute inset-0 bg-[#00f0ff] rounded-full blur opacity-20 group-hover:opacity-50 transition-opacity"></div>
