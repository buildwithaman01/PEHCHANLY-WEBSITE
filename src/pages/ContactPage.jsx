...
const ContactPage = () => (
  <div className="pt-32 pb-24 px-6 container mx-auto animate-fadeIn">
    ...
    <div className="max-w-5xl mx-auto bg-[#0a0e26] rounded-3xl border border-white/10 overflow-hidden shadow-2xl grid md:grid-cols-2">
      <div className="p-12 bg-gradient-to-br from-[#00f0ff]/10 to-[#0a0e26] border-r border-white/5">
        ...
        <div className="space-y-8">
          {[
            { icon: Mail, title: "Email", val: BRAND.email },
            { icon: Phone, title: "WhatsApp / Phone", val: BRAND.phone },
            { icon: MapPin, title: "Location", val: BRAND.location }
          ].map((item, i) => (
      ...
      <div className="p-12">
        <form className="space-y-6" action="https://formsubmit.co/pehchanly.digitalsolution@gmail.com" method="POST">
          <div>
            <label className="block text-xs font-bold uppercase text-gray-500 mb-2">Name</label>
            <input name="name" className="w-full bg-[#050816] border border-white/10 rounded-lg p-4 text-white focus:border-[#00f0ff] focus:outline-none transition-colors" placeholder="Your Name" required />
          </div>
          <div className="grid grid-cols-2 gap-4">
             <div>
                <label className="block text-xs font-bold uppercase text-gray-500 mb-2">Phone</label>
                <input name="phone" className="w-full bg-[#050816] border border-white/10 rounded-lg p-4 text-white focus:border-[#00f0ff] focus:outline-none transition-colors" placeholder="+91..." required />
             </div>
             <div>
                <label className="block text-xs font-bold uppercase text-gray-500 mb-2">Business Name</label>
                <input name="business" className="w-full bg-[#050816] border border-white/10 rounded-lg p-4 text-white focus:border-[#00f0ff] focus:outline-none transition-colors" placeholder="Company Ltd." />
             </div>
          </div>
          <div>
            <label className="block text-xs font-bold uppercase text-gray-500 mb-2">Email</label>
            <input name="email" type="email" className="w-full bg-[#050816] border border-white/10 rounded-lg p-4 text-white focus:border-[#00f0ff] focus:outline-none transition-colors" placeholder="your@email.com" required />
          </div>
          <div>
            <label className="block text-xs font-bold uppercase text-gray-500 mb-2">Interest</label>
            <select name="interest" className="w-full bg-[#050816] border border-white/10 rounded-lg p-4 text-white focus:border-[#00f0ff] focus:outline-none transition-colors appearance-none">
          ...
          <div>
             ...
             <select name="budget" className="w-full bg-[#050816] border border-white/10 rounded-lg p-4 text-white focus:border-[#00f0ff] focus:outline-none transition-colors appearance-none">
